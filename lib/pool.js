...
var hashingUtil = "cnHashing";

var cryptoNight;
if (cnAlgorithm === "bittube" || cnAlgorithm === "none") //the example ipbc.json originally used "none" as cnAlgorithm
{
    cryptoNight = multiHashing['cryptonight_bittube'];
    var hashingUtil = "multiHashing";
}
...
function getBlockTemplate(callback){
    apiInterfaces.rpcDaemon('getblocktemplate', {reserve_size: 17, wallet_address: config.poolServer.poolAddress}, callback);
}
